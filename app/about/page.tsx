        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="flex-1">
            <p className="text-white/80 text-lg leading-relaxed mb-4">
              Hi there — I&apos;m Tom. I&apos;ve spent years as a Marketo administrator and campaign executor in B2B environments, building campaigns from first concept through to final reporting and working closely with stakeholders at every stage along the way. It&apos;s work that rewards both creative thinking and process discipline; this combination plays to my strengths and has retained my interest in the field.
            </p>
            <p className="text-white/80 text-lg leading-relaxed mb-4">
